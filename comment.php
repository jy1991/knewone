<?php 
  ...
  $goods_id=$_GET['goods_id'];
   $sql="SELECT * FROM ".PRE."order_goods WHERE order_number='{$number}' AND goods_id='{$goods_id}'";
...
<div id="main" class="m0a">
  ...
  <div class="content fl">
    ...
    <ul>
	  ...
	  $sql="SELECT name FROM ".PRE."image WHERE goods_id={$goods_id} AND is_face=1";
	  $result=mysql_query($sql);
	  $img='';
	  if($result && mysql_num_rows($result)>0)
	  {
      ...
      <div class="name fl">
         ...
         <div class="cal_price">
          <span class="unit_price">￥<?php echo $goods['price'] ?></span>
           ...
           <span class="num"><?php echo $goods['qty']; ?></span>
           
           <span class="sum"><?php $total=$goods['price']*$goods['qty']; echo $total; ?></span>
    ...
    <div class="bottom">
      <div class="bar">
      <span>评价内容：</span>
<form name="submit_comment" action="action.php?a=comment" method="post">
<input type="hidden" name="number" value="<?php echo $number; ?>">
<input type="hidden" name="goods_id" value="<?php echo $goods_id ?>">
      <textarea id="comment" name="content" class="fl" rows="10" cols="80"></textarea>
      ...
      <div class="cb"></div>
      <a>
       <span class="pay_btn" style="margin-left:550px; margin-top:-40px;"  onClick="document.submit_comment.submit();">评&nbsp;&nbsp;论</span>
      </a>  
      </form>   
      </div>
