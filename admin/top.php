...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="header">
  <tr>
    <td rowspan="2" align="left" valign="top" id="logo"><img src="images/main/logo.png" width="64" height="64"></td>
    <td align="left" valign="bottom">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="bottom" id="header-name">KnewOne - 分享科技与设计产品，发现更好的生活</td>
        <td align="right" valign="top" id="header-right">
        	<a href="index.php?state=logoff" target="_top" onFocus="this.blur()" class="admin-out">注销</a>
