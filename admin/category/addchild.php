...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <form method="post" action="action.php?a=addchild">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      <td align="right" valign="middle" class="borderright borderbottom bggray">父类名：</td>
      <td align="left" valign="middle" class="borderright borderbottom main-for">
      <input type="text" name="fa_name" value="<?php echo $name ?>" class="text-word" disabled>
     <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <input type="hidden" name="pid" value="<?php echo $pid?>" class="text-word">
">
      <input type="hidden" name="path" value="<?php echo $path?>" class="text-word">
