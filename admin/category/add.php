...
include '../init.php';
//查询所有类
  $sql ="SELECT id,name,pid,path,display,concat(path,id,',') as bpath FROM ".PRE."category ORDER BY bpath";
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">新增分类</a>
    </td>
  </tr>
  <tr>
    ...
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <select name="pid" id="level">
        <option value="0" >&nbsp;&nbsp;<?php echo '顶级分类' ?></option>
