...
<?php
    ...
    $sql ="SELECT * FROM ".PRE."user WHERE id=".$id;
...
<!--    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <input style="display:none" type="text" name="last_type" value="<?php echo $row['type'] ?>">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">用户权限：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <select name="type" id="level">
        <option value="0" <?php echo $row['type']==0?'selected':''?> >&nbsp;&nbsp;普通用户</option>
	    <option value="1" <?php echo $row['type']==1?'selected':''?>>&nbsp;&nbsp;普通管理员</option>
	    <option value="2" <?php echo $row['type']==2?'selected':''?>>&nbsp;&nbsp;超级管理员</option>
        </select>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <lable><input type="radio" name="sex" value="0" <?php echo $row['sex']==0?'checked':'' ?>><span class="text-word">女</span></label>
        <lable><input type="radio" name="sex" value="1" <?php echo $row['sex']==1?'checked':'' ?>><span class="text-word">男</span></label>
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
